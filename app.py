...
def index():
    ...
    return render_template('table.html', data=data, branches=branches, selected_branches=selected_branches, sort_by=sort_by, order='desc' if reverse else 'asc', search_query=search_query)
