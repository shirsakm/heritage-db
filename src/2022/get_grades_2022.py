...
def get_grades_2023():
    ...
    writer = csv.writer(f)
    writer.writerow([
        "Autonomy Roll", "Name", "CGPA 1", "CGPA 2", "YGPA 1", "CGPA 3", "CGPA 4", "YGPA 2", "CGPA 5", "CGPA 6", "YGPA 3", "Department"
    ])
    ...
    for branch_code in range(1, 21):
        ...
        for roll_num in range(1, 201):
            if null_count >= 10:
                break
            autonomy_roll = f"126220{str(branch_code).zfill(2)}{str(roll_num).zfill(3)}"
            ...
            try:
                ...
                cgpa_5 = cgpa_6 = ygpa_3 = "N/A"
            writer.writerow([autonomy_roll, name, cgpa_1, cgpa_2, ygpa_1, cgpa_3, cgpa_4, ygpa_2, cgpa_5, cgpa_6, ygpa_3, dept])
            driver.back()
            driver.find_element(By.NAME, "reset1").click()
